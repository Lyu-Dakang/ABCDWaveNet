...
class DoubleConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, mid_channels=None, groups=1):
        """
        Initializes the DoubleConv module with group convolutions.

        Args:
            in_channels (int): Number of input channels.
            out_channels (int): Number of output channels.
            mid_channels (int, optional): Number of intermediate channels. Defaults to out_channels.
            groups (int, optional): Number of groups for group convolution. Defaults to 1 (standard convolution).
        """
...
class Down(nn.Module):
    """Downscaling with maxpool then group double conv"""
...
class OutConv(nn.Module):
    """Output convolution layer with group convolution."""
    
    def __init__(self, in_channels, out_channels, groups=1):
        """
        Initializes the OutConv module with group convolutions.
        ...
        self.conv = nn.Conv2d(
            ...
            kernel_size=1,
            groups=groups,
            bias=True  # Set to False if followed by BatchNorm
        )
